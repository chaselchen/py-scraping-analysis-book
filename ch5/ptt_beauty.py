...
def get_articles(dom, date):
    ...
    for d in divs:
        # 發文日期正確
        # if d.find('div', 'date').text.strip() in ['7/22', '7/21', '7/20', '7/19', '7/18']:
        if d.find('div', 'date').text.strip() in ['7/23', '7/22', '7/21', '7/20', '7/19', '7/18', '7/17', '7/16', '7/15', '7/14', '7/13', '7/12']:
            # 取得推文數
            push_count = 0
...
if __name__ == '__main__':
    ...
    if current_page:
        ...
        for article in articles:
            ...
            if page:
                img_urls = parse(page)
                if article['push_count'] > 20:
                    print(article['push_count'])
